...
export const products: Product[] = [
  {
    ...
    imagen: '/products/te-extractos-de-la-vida-v2.png',
...
export const affiliatePackages: AffiliatePackage[] = [
  {
    ...
    imagen: '/packs/pack-basico-v2.png',
    tagline: 'Tu primer paso hacia el bienestar y el negocio',
    descripcion:
      'El kit ideal para empezar tu camino con Sumak. Incluye 9 productos elegidos por ti del catálogo a precio especial de afiliado, más el acceso completo a la red multinivel.',
  },
  {
