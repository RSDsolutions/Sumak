  ...
  return (
    <div
      className={`flex flex-col items-center justify-center rounded-xl px-4 py-3 border text-center min-w-[80px] ${
        highlight
          ? 'bg-[#1A4E26] border-[#1A4E26] text-white shadow-[0_0_20px_rgba(26,78,38,0.4)]'
          : 'bg-white border-[#C8D8CB] text-[#111111]'
      }`}
    >
...
function TreeLine() {
  return <div className="w-px h-6 bg-[#C8D8CB]" />;
}

function TreeHLine({ wide = false }: { wide?: boolean }) {
  return <div className={`h-px bg-[#C8D8CB] ${wide ? 'w-32 sm:w-48' : 'w-16 sm:w-24'}`} />;
}
...
export default function Plan() {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-12">
              ...
              <div className="w-16 h-1 bg-[#1A4E26] rounded-full mx-auto mb-5" />
              ...
              <div className="flex flex-col items-center min-w-[320px]">
                ...
                <div className="flex gap-32 sm:gap-48">
                  <div className="flex flex-col items-center gap-0">
                    <div className="w-px h-0 bg-[#C8D8CB]" />
                ...
                <p className="text-[#9CA3AF] text-xs mt-8">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-12">
              ...
              <div className="w-16 h-1 bg-[#1A4E26] rounded-full mx-auto" />
            </motion.div>

            {/* 4 cards */}
            <motion.div variants={stagger} className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                { label: 'Volumen Izquierda', val: '$1,000', color: 'text-[#6B7280]' },
                { label: 'Volumen Derecha', val: '$1,000', color: 'text-[#6B7280]' },
                { label: 'Volumen Pareado', val: '$1,000', color: 'text-[#D4AF37]' },
                { label: 'Comisión 50%', val: '$500', color: 'text-[#1A4E26]' },
              ].map((card) => (
                <motion.div
                  key={card.label}
                  variants={fadeUp}
                  className="bg-[#F4F7F5] border border-[#C8D8CB] rounded-xl p-5 text-center"
                >
            ...
            <motion.div
              variants={fadeUp}
              className="bg-gradient-to-r from-[#EBF4ED] to-[#F4F7F5] border border-[#1A4E26]/30 rounded-xl p-6 text-center"
            >
              <p className="text-[#6B7280] text-sm mb-3 font-medium uppercase tracking-wider">
                Ejemplo de cálculo
              </p>
              <p className="font-heading text-[#111111] text-xl sm:text-2xl">
                Izq: <span className="text-[#6B7280]">$1,000</span>
                &nbsp;+&nbsp;
                Der: <span className="text-[#6B7280]">$1,000</span>
                &nbsp;=&nbsp;
                <span className="text-[#D4AF37]">$1,000 pareado</span>
                &nbsp;=&nbsp;
                <span className="text-[#1A4E26] font-bold">$500 comisión</span>
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* Affiliation Bonus */}
      <section className="py-10 px-4 sm:px-6 bg-[#F4F7F5]">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            className="bg-white border-2 border-[#D4AF37]/40 rounded-2xl p-8 text-center shadow-[0_0_40px_rgba(212,175,55,0.1)]"
          >
            <p className="text-[#D4AF37] text-sm font-semibold uppercase tracking-widest mb-3">
              Bono Especial
            </p>
            <h3 className="font-heading font-bold text-3xl sm:text-4xl text-[#111111] mb-4">
            ...
            <p className="text-[#6B7280] text-base max-w-lg mx-auto">
              ...
              Esto equivale a <strong className="text-[#111111]">$50 fijos</strong> por afiliación,
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="bg-white border border-[#C8D8CB] rounded-2xl overflow-hidden">
              <div className="grid grid-cols-2 bg-[#EBF0EC] px-6 py-3 border-b border-[#C8D8CB]">
                <span className="text-[#6B7280] text-xs font-semibold uppercase tracking-wider">Nivel</span>
                <span className="text-[#6B7280] text-xs font-semibold uppercase tracking-wider text-right">Comisión</span>
              </div>
              {levelCommissions.map((lc) => (
                <div
                  key={lc.nivel}
                  className={`grid grid-cols-2 px-6 py-3.5 border-b border-[#C8D8CB] last:border-0 ${
                    lc.nivel === 2
                      ? 'bg-[#1A4E26]/8'
                      : ''
                  }`}
                    ...
                    <span
                      className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold ${
                        lc.nivel === 2
                          ...
                          : 'bg-[#EBF0EC] text-[#6B7280]'
                      }`}
                    >
                      {lc.nivel}
                    </span>
                    <span className={`text-sm ${lc.nivel === 2 ? 'text-[#111111] font-semibold' : 'text-[#6B7280]'}`}>
                      Nivel {lc.nivel}
                      {lc.nivel === 2 && <span className="ml-2 text-[10px] text-[#1A4E26] font-bold uppercase">Mayor</span>}
                    </span>
                  </div>
                  <span className={`text-right font-bold text-base ${
                    lc.nivel === 2 ? 'text-[#1A4E26]' : 'text-[#111111]'
                  }`}>
                    {lc.porcentaje}%
                  </span>
                </div>
            ...
            <motion.p variants={fadeUp} className="text-center text-[#9CA3AF] text-sm mt-4">
      ...
      <section className="py-16 px-4 sm:px-6 bg-[#F4F7F5]">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="bg-white border border-[#C8D8CB] rounded-2xl p-8">
              <p className="text-[#6B7280] text-base mb-6 text-center">
                Compra al <span className="text-[#1A4E26] font-bold">50% del PVP</span>, vende al precio público.
                Ganancia directa del <span className="text-[#1A4E26] font-bold">50%</span>.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { label: 'PVP Público', val: '$25.00', color: 'text-[#6B7280]' },
                  { label: 'Tu Costo (50%)', val: '$12.50', color: 'text-[#D4AF37]' },
                  { label: 'Tu Ganancia', val: '$12.50', color: 'text-[#1A4E26]' },
                ].map((item) => (
                  <div key={item.label} className="bg-[#F4F7F5] rounded-xl p-5 text-center">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-10">
              ...
              <p className="text-[#6B7280] text-sm">Si cada persona invita a 2 personas...</p>
              <div className="w-16 h-1 bg-[#1A4E26] rounded-full mx-auto mt-3" />
            </motion.div>
            ...
            <motion.div variants={stagger} className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
              {[
                ...
                <motion.div
                  key={row.nivel}
                  variants={fadeUp}
                  className="bg-[#F4F7F5] border border-[#C8D8CB] rounded-xl p-4 text-center"
                  style={{ opacity: 0.6 + i * 0.06 }}
                >
                  <p className="text-[#9CA3AF] text-[10px] uppercase tracking-wider mb-1">Nivel {row.nivel}</p>
                  <p className="font-heading font-bold text-xl text-[#1A4E26]">{row.personas}</p>
                  <p className="text-[#6B7280] text-[10px]">personas</p>
                </motion.div>
              ))}
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="mt-8 text-center">
              <Link
                to="/escaleras"
                className="inline-flex items-center gap-2 text-[#1A4E26] font-semibold text-sm hover:underline"
              >
