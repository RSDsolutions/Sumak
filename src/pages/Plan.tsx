    ...
    <section className="relative pt-32 pb-24 px-4 sm:px-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0F2E18 0%, #1A4E26 55%, #0F2E18 100%)' }}>
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        >
          ...
          de profundidad, venta directa al 50% y carrera de rangos con premios físicos
          y bonos económicos.
        </motion.p>
...
const INCOME_STREAMS = [
  ...
  },
  {
    ...
    short: 'Premios económicos + físicos por escalar',
    detail: 'Cada rango alcanzado en la escalera del éxito desbloquea un bono económico único y, en los rangos superiores, premios físicos: viajes locales, nacionales, internacionales, electrodomésticos, vehículos y una casa al alcanzar Fundador Internacional.',
    metric: 'Hasta $1M',
    metricLabel: '+ Casa',
    color: '#EF4444',
  ...
  return (
    <section className="py-20 px-4 sm:px-6 bg-cta-gradient relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          5 fuentes de ingreso, sistema flexible con frontales múltiples, comisiones por 14 niveles
          y una carrera de rangos con premios que cambian vidas.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          whileInView={{ opacity: 1, y: 0 }}
...
export default function Plan() {
  useSEO({
    ...
    description:
      'Plan de compensación SUMAK con 5 fuentes de ingreso: venta directa al 50%, bono de afiliación del 40%, sistema binario con frontales múltiples, comisiones por 14 niveles y bonos de rango con premios físicos.',
    url: '/plan-multinivel',
  });
